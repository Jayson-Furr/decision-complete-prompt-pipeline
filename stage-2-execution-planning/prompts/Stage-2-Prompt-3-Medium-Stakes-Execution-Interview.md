# Stage 2 Prompt 3 — Medium-Stakes Execution Interview
...
Execution Logging Level: Medium-Stakes Execution Logging
```
...
2. Resolve safe low-stakes execution decisions without interview.
3. Interview the user for unresolved medium- and high-stakes execution decisions.
4. Elevate low-stakes decisions that materially affect medium- or high-stakes outcomes.
...
Interview the user only for unresolved medium- and high-stakes execution decisions unless a low-stakes issue is elevated for materiality.
...
| Prompt Mode | Medium-Stakes Execution Interview |
| Active Logging Level | Medium-Stakes Execution Logging |
...
Because this mode uses Medium-Stakes Execution Logging, summarize low-stakes execution decisions below threshold using the standard below-threshold summary table.
...
Begin with the Stage 2 Medium-Stakes Execution Interview if unresolved medium- or high-stakes decisions remain. Otherwise produce the final artifact.

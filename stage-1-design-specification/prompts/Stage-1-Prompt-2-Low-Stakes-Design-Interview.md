# Stage 1 Prompt 2 — Low-Stakes Design Interview
...
```text
Prompt Mode: Low-Stakes Design Interview
Interview Threshold: Low and above
Design Logging Level: Low-Stakes Design Logging
```

In this mode:

```text
1. Review all input and identify unresolved low-, medium-, and high-stakes design decisions.
2. Interview the user for low-, medium-, and high-stakes decisions.
...
Interview the user for unresolved low-stakes, medium-stakes, and high-stakes design decisions.
...
M. Unresolved Low-Stakes Design Decisions
...
| Prompt Mode | Low-Stakes Design Interview |
| Active Logging Level | Low-Stakes Design Logging |
...
Begin by performing the Stage 1 Low-Stakes Design Interview. After required answers or safe handling are complete, produce the final artifact.

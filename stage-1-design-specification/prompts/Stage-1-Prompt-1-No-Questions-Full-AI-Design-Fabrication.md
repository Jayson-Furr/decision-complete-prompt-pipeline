# Stage 1 Prompt 1 — No Questions — Full AI Design Fabrication
...
```text
Prompt Mode: No Questions — Full AI Design Fabrication
Interview Threshold: None
Design Logging Level: Full AI Design Fabrication Logging
```
...
2. Use all available context and safe AI-selected defaults.
3. Convert missing information into controlled placeholders when needed.
4. Mark high-stakes uncertainty as review-gated, professionally reviewed, externally authorized, excluded, or not applicable.
5. Line-item log all meaningful low-, medium-, and high-stakes design decisions.
6. Produce the Stage 1 artifact immediately.
```

No interview is performed in this mode.
...
Do not perform an interview. Analyze the input, make safe AI-selected design decisions, preserve unknowns through controlled placeholders, mark review-gated items, and produce the Stage 1 artifact immediately.

Still perform decision analysis internally and record all meaningful low-, medium-, and high-stakes design decisions in the required registers and ledgers.
...
| Prompt Mode | No Questions — Full AI Design Fabrication |
| Active Logging Level | Full AI Design Fabrication Logging |
...
For this mode, the Below-Threshold Decision Summary should state: `Not applicable. This mode line-item logs low-, medium-, and high-stakes design decisions.`
...
Produce the final Stage 1 artifact now. Do not ask clarifying questions.

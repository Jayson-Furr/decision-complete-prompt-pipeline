# Stage 3 Prompt 4 — High-Stakes Fabrication Interview
...
```text
Prompt Mode: High-Stakes Fabrication Interview
Interview Threshold: High only
Fabrication Logging Level: High-Stakes Fabrication Logging
```
...
3. Make safe medium-stakes fabrication decisions without asking the user.
4. Interview the user only for unresolved high-stakes fabrication decisions.
5. Use controlled placeholders, review gates, blockers, external-tool-required handling, exclusions, or not-applicable determinations for high-stakes issues that cannot safely be executed.
6. Line-item log all meaningful high-stakes fabrication decisions.
7. Summarize low- and medium-stakes fabrication decisions below threshold.
8. Elevate any low- or medium-stakes decision that materially affects a high-stakes outcome.
```
...
Before fabrication, perform a Stage 3 High-Stakes Fabrication Interview only if unresolved high-stakes fabrication decisions remain. Analyze Stage 2 intake, active configuration, execution lock, design lock, fabrication scope, work package execution plan, text-file strategy, binary/external-tool strategy, validation strategy, resolved decisions, low-stakes decisions the AI will resolve, medium-stakes decisions the AI will resolve, unresolved high-stakes decisions, recommended high-stakes safe handling options, and interview questions. Do not ask low- or medium-stakes questions unless elevated for materiality because they directly affect a high-stakes issue. If no unresolved high-stakes questions exist, proceed directly to fabrication.
...
| Prompt Mode | High-Stakes Fabrication Interview |
| Active Logging Level | High-Stakes Fabrication Logging |
...
Because this mode uses High-Stakes Fabrication Logging, line-item log high-stakes fabrication decisions. Summarize non-elevated low- and medium-stakes fabrication decisions in the Below-Threshold Fabrication Decision Summary.
...
Begin by performing the Stage 3 High-Stakes Fabrication Interview if unresolved high-stakes fabrication decisions remain. Do not ask low- or medium-stakes fabrication questions unless they are elevated for materiality because they directly affect a high-stakes issue. If no unresolved high-stakes decisions remain after context review, proceed directly to fabrication.
